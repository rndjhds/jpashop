...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        ...
        result.forEach(o -> o.setOrderItemQuery(orderItemMap.get(o.getOrderId())));
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery("select new jpabook.jpashop.repository.order.query.OrderFlatDto(o.id, m.username, o.orderDate, o.orderStatus, d.address, i.name, oi.orderPrice, oi.count)" +
                "from Order o " +
                "join o.member m " +
                "join o.delivery d " +
